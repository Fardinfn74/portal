...
> = {
  ...
  gallery_basement: {
    label: 'Basement',
    path: '/home/fardin/Pictures/Basement',
    summary: 'Basement photos.',
    entries: [
      {
        name: 'basement_01.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 1',
        fields: { url: '/gallery/basement/basement_01.jpg' },
      },
      {
        name: 'basement_02.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 2',
        fields: { url: '/gallery/basement/basement_02.jpg' },
      },
      {
        name: 'basement_03.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 3',
        fields: { url: '/gallery/basement/basement_03.jpg' },
      },
      {
        name: 'basement_04.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 4',
        fields: { url: '/gallery/basement/basement_04.jpg' },
      },
      {
        name: 'basement_05.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 5',
        fields: { url: '/gallery/basement/basement_05.jpg' },
      },
      {
        name: 'basement_06.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 6',
        fields: { url: '/gallery/basement/basement_06.jpg' },
      },
      {
        name: 'basement_07.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 7',
        fields: { url: '/gallery/basement/basement_07.jpg' },
      },
      {
        name: 'basement_08.jpg',
        type: 'image/jpeg',
        description: 'Basement photo 8',
        fields: { url: '/gallery/basement/basement_08.jpg' },
      },
    ],
  },
  gallery_hackathons: {
    label: 'Hackathons',
    path: '/home/fardin/Pictures/Hackathons',
    summary: 'Hackathon photos.',
    entries: [],
  },
  welcome: {
    label: 'Welcome',
